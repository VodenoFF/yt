...
<html lang="en">
<head>
    <title>History - AdminPanel</title>
    <meta charset="utf-8">
...
<?php
$all_history = mysql_query("SELECT * FROM History",$bd);
$result_history = mysql_num_rows($all_history);
?>
<span class="h2class">Total:<span class="badge bg-theme"><b><?php echo $result_history; ?></b></span>
...
<tbody align="center">
																				<tr>			<td>'.$row['id'].'</td>
																								...
																								<td> <img src="https://img.youtube.com/vi/'.$row['url'].'/hqdefault.jpg" width="100" height="80" "/></td>
